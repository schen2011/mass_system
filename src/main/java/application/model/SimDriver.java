        ...
        do {
            ...
            switch (tokens[0]) {
                ...
                case "add_train_route":
                    ...
                    break;
                case "add_bus":
                    int busID = martaModel.makeBus(Integer.parseInt(tokens[1]), Integer.parseInt(tokens[2]), Integer.parseInt(tokens[3]), Integer.parseInt(tokens[4]), Integer.parseInt(tokens[5]), Integer.parseInt(tokens[6]), tokens[7]);
                ...
                case "extend_bus_route":
                    ...
                    martaModel.appendRoadToRoute(Integer.parseInt(tokens[1]), Double.parseDouble(tokens[3]), Double.parseDouble(tokens[4]), Double.parseDouble(tokens[5]));
        ...
        try {
            ...
            while (rs.next()) {
                ...
                for (int i = 0; i < busesOnRoute; i++) {
                    martaModel.makeBus(busID, routeID, startingPosition + i * skip, 0, 10, 1, null);
